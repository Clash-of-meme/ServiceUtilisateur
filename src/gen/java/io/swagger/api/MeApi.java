...
public class MeApi  {
   private final MeApiService delegate = MeApiServiceFactory.getMeApi();
    ...
    @Consumes({ "application/json", "application/xml" })
    @Produces({ "application/json", "application/xml" })
    @io.swagger.annotations.ApiOperation(value = "Information utilisateur", notes = "Endpoint de connexion. ", response = User.class, authorizations = {
    ...
    public Response meGet(@ApiParam(value = "Token d'un utilisateur" ,required=true) Token user
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.meGet(user,securityContext);
    }
}
